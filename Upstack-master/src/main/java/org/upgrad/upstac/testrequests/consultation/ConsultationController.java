...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        // For reference check the method getForTests() method from LabRequestController class
           ...
           return testRequestQueryService.findBy(RequestStatus.LAB_TEST_COMPLETED); // This implementation will get the list of test requests for which lab test is completed
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        User loggedInDoctor = userLoggedInService.getLoggedInUser(); // Created an object to store logged in doctor
        return testRequestQueryService.findByDoctor(loggedInDoctor); // This will return the list of test requests assigned to the doctor.
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            ...
            User loggedInDoctor = userLoggedInService.getLoggedInUser(); // Created an object to store logged in doctor
            return testRequestUpdateService.assignForConsultation(id,loggedInDoctor); // This will assign the test request to the doctor for consultation based on the id
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            User loggedInDoctor = userLoggedInService.getLoggedInUser(); // // Created an object to store logged in doctor
            return testRequestUpdateService.updateConsultation(id,testResult,loggedInDoctor); // This is implemented to update the test request id with the test results provided by the doctor
