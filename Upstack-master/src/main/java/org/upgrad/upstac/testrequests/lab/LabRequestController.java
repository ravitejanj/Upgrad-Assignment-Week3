...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User loggedInTester = userLoggedInService.getLoggedInUser(); // Created an object to store current logged in tester
        return testRequestQueryService.findByTester(loggedInTester); // This will return the list of test requests assigned to the tester
